...
def main():
    ...
    # Ensure node is executed from the brave root directory, node.RunNode offers no option for
    # passing in a custom working directory. This is required for paths in the webpack config to
    # be parsed correctly.
